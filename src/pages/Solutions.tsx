...
const SolutionCard = ({ project }: { project: SolutionProject }) => (
  <motion.div
    ...
    className="group bg-white rounded-[24px] p-6 md:p-8 border border-black/5 hover:border-black/20 hover:shadow-2xl hover:shadow-black/5 transition-all duration-500 flex flex-col h-full overflow-hidden relative"
  >
    <div className="relative z-10 flex flex-col h-full">
      ...
      <p className="text-black/40 text-sm mb-6 line-clamp-3">
        {project.description}
      </p>
...
const Solutions = () => {
  ...
  return (
    <Layout>
      <div className="pt-24 pb-24 min-h-screen bg-brand-gray/30">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-6xl font-medium tracking-tighter uppercase leading-none">
                Industrial <br /> Solutions
              </h1>
              <p className="text-base md:text-lg text-black/40 mt-6 font-medium">
              ...
              {filteredProjects.length > 0 ? (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <h3 className="text-4xl md:text-6xl font-medium tracking-tighter uppercase mb-6">Yet to be <br /> Updated</h3>
                    <p className="text-black/40 text-lg md:text-xl font-medium max-w-md mx-auto">
                      Our industrial solutions repository is being compiled and will be published soon.
                    </p>
                    <div className="mt-12 flex items-center justify-center gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#FF4A22] animate-pulse" />
                      <span className="text-[10px] font-bold uppercase tracking-widest text-black/60">Coming soon</span>
                    </div>
                  </div>
                </motion.div>
              )}
